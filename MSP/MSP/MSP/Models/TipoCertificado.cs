...
namespace MSP.Models
{
    ...
    public partial class TipoCertificado
    {
        ...
        public TipoCertificado()
        {
            ...
            this.TipoCertificadoEstablecimiento = new HashSet<TipoCertificadoEstablecimiento>();
        }
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<TipoCertificadoEstablecimiento> TipoCertificadoEstablecimiento { get; set; }
    }
}
