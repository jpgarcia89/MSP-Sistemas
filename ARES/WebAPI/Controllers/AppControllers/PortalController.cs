        ...
        public async Task<IHttpActionResult> GetNoticia()
        
           {
            ...
            try
            {
                ...
                //value = Regex.Replace(value, "colspan=.+?>", ">", RegexOptions.IgnoreCase | RegexOptions.Singleline);
                //value = Regex.Replace(value, "colspan=.+?\\s", " ", RegexOptions.IgnoreCase | RegexOptions.Singleline);
                //value = Regex.Replace(value, "width=.+?>", ">", RegexOptions.IgnoreCase | RegexOptions.Singleline);
                //value = Regex.Replace(value, "width=.+?\\s", " ", RegexOptions.IgnoreCase | RegexOptions.Singleline);
                //value = Regex.Replace(value, "dir=.+?>", ">", RegexOptions.IgnoreCase | RegexOptions.Singleline);
                //value = Regex.Replace(value, "dir=.+?\\s", " ", RegexOptions.IgnoreCase | RegexOptions.Singleline);
